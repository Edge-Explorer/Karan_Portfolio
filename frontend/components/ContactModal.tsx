                            ...
                            {status === "success" ? (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-white text-black rounded-xl py-3 text-sm font-bold flex items-center justify-center gap-2 hover:bg-white/90 transition-all disabled:opacity-50 shadow-lg"
                                    >
                                        <Send size={16} />
